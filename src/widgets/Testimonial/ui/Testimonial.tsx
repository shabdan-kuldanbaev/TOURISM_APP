      ...
      <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
        <figure className="max-w-screen-md mx-auto">
          ...
          >
            ...
            <path
              d="M14.017 18L14.017 10.609C14.017 4.905 17.748 1.039 23 0L23.995 2.151C21.563 3.068 20 4.779 20 8.262L20 18L14.017 18Z"
              fill="currentColor"
            />
            <path
              d="M0 18L0 10.609C0 4.905 3.748 1.038 9 0L9.996 2.151C7.563 3.068 6 4.779 6 8.262L6 18L0 18Z"
              fill="currentColor"
            />
          </svg>
          <blockquote>
